      ...
      >
        <div className="flex items-center justify-start w-full">
          ...
          {showContent === "Position" ? (
            ...
            <motion.p
              className="text-left w-1/2 text-[2.5vw] font-light leading-relaxed tracking-wide"
              style={{
                opacity: taglineOpacity,
                y: taglineY,
              }}
            >
              Our <span className="text-blue-400">President</span> leads with
              vision and dedication, inspiring the team to achieve excellence in
              all endeavors.
            </motion.p>
          ) : showContent === "Details" ? (
