...
const EventsPage = () => {
  ...
  const eventData = [
    {
      eventId: "E007",
      eventName: "Workshop on : CyberSentinels",
      eventDate: "15",
      eventMonth: "February",
      eventYear: "2025",
      ...
      location: "E - 322",
      description:
        "An interactive session designed to empower you with essential cybersecurity tools and techniques. Explore hands-on practices in threat detection, risk mitigation, and proactive defense to become a vigilant digital guardian.",
      instagramLink: "https://instagram.com/techtalk_ai",
      linkedInLink: "https://linkedin.com/company/techtalk_ai",
      posterPhoto: "/Events/WORK_ON_CYBER_SENTINELS_15_FEB_2025.jpg",
      Speaker: {
        name: "Rashmi Rout",
        Position: "Professor",
    ...
    {
      eventId: "E006",
      eventName: "Demystifying the power of AI for everyone",
      eventDate: "13",
      eventMonth: "January",
      eventYear: "2025",
      eventTime: "10:00 AM - 01:30 PM",
      location: "E - 322",
      description:
        "A beginner-friendly session aimed at simplifying AI concepts, breaking down its real-world impact, and making cutting-edge tech accessible to all.",
      instagramLink: "https://instagram.com/techtalk_ai",
      linkedInLink: "https://linkedin.com/company/techtalk_ai",
      posterPhoto: "/Events/POWER_OF_AI_13_JAN_2025.jpg",
      Speaker: {
        name: "ACM Team",
        Position: "GHRCEM (2024 - 2025)",
        Company: "GHRCEM",
        bio: "Dr. Jane Smith is a leading AI researcher with over 10 years",
        photo: "/speakers/jane_smith.jpg",
      },
    ...
    {
      eventId: "E004",
      eventName: "Investiture Ceremony 2024",
      eventDate: "24",
      eventMonth: "August",
      eventYear: "2024",
      eventTime: "10:15 AM - 01:30 PM",
      location: "E - 316",
      description:
        "An engaging session exploring the fundamentals and real-world applications of cloud computing. The event aimed to introduce students to cloud platforms, deployment models, and the future of scalable tech infrastructure.",
      instagramLink: "https://instagram.com/techtalk_ai",
      linkedInLink: "https://linkedin.com/company/techtalk_ai",
      posterPhoto: "/Events/CLOUD_COMPUTING_24_AUG_2024.jpg",
      Speaker: {
        name: "Aman Mishra",
    ...
    },
    {
      ...
      location: "E - 316",
      description:
        "The Investiture Ceremony 2024 welcomed the newly appointed leads and members of the ACM Student Chapter for the 2024–2025 term. The event celebrated leadership, collaboration, and a shared vision for innovation. With fresh energy, the chapter begins its journey toward impactful learning and tech-driven growth.",
      instagramLink: "https://instagram.com/techtalk_ai",
      linkedInLink: "https://linkedin.com/company/techtalk_ai",
      posterPhoto: "/Events/INVESTITURE_CEREMONY_13_AUG_2024.png",
      Speaker: {
        name: "Meenakshi Thalor",
